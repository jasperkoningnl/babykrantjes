  ...
  if (daysAgo >= 0 && daysAgo <= 7) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log(`[TV API] kijkonderzoek.nl returned no data (error: ${data.error}), trying tvblik.nl...`)
      } else {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log(`[TV API] tvblik.nl returned no data (error: ${data.error}), falling back to Layer 3`)
      } else {
